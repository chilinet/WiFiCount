...
# WiFiCount Docker Setup with MySQL
echo "🚀 Setting up WiFiCount with Docker and MySQL..."
...
if [[ "$COMPOSE_VERSION" == "1."* ]]; then
    echo "📁 Using legacy format for Docker Compose 1.x"
    COMPOSE_FILE="docker-compose-simple.yml"
else
    echo "📁 Using modern format for Docker Compose 2.x+"
